        ...
        <form onSubmit={saveProfile} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Used to show public holidays in your calendar.
            </p>
          </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    annual_vacation_days: Number(e.target.value),
                  }))
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    daily_target_hours: Number(e.target.value),
                  }))
                }
              />
            </div>
